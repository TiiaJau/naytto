...
function lahetaVahvavain($email,$url) {
  $message = "Hei!\n\n" . 
             "Olet rekisteröitynyt Teerivaaran koiraharrastajien sivuille tällä\n" . 
             "sähköpostiosoitteella. Klikkaamalla alla olevaa\n" . 
             "linkkiä vahvistat käyttämäsi sähköpostiosoitteen\n" .
             "ja pääset kirjautumaan sivuillemme.\n\n" . 
             "$url\n\n" .
             "Jos et ole rekisteröitynyt Teerivaaran koiraharrastajien sivuille, niin\n" . 
             "silloin tämä sähköposti on tullut sinulle\n" .
             "vahingossa. Siinä tapauksessa ole hyvä ja\n" .
             "poista tämä viesti.\n\n".
             "Terveisin, Teerivaaran koiraharrastajat Ry";
  return mail($email,'Teerivaaran koiraharrastajien tilin aktivointilinkki',$message);
}
...
function lahetaVaihtoavain($email,$url) {
  $message = "Hei!\n\n" .
             ...
             "Terveisin, Teerivaaran koiraharrastajat Ry";
  return mail($email,'Teerivaaran koiraharrastajat-tilin salasanan vaihtaminen',$message);
}
